...
static HANDLE WINAPI LoadLibraryExW(LPCWSTR lpFileName, HANDLE hFile, DWORD dwFlags) {
...
STATIC HANDLE WINAPI LoadLibraryA(PVOID lpFileName)
{
...
static HANDLE WINAPI GetModuleHandleW(LPCWSTR lpModuleName) {
...
static DWORD WINAPI GetModuleFileNameA(HANDLE hModule, PCHAR lpFilename, DWORD nSize) {
    ...
    strncpy(lpFilename, "C:\\dummy\\fakename.exe", sizeof("C:\\dummy\\fakename.exe"));
